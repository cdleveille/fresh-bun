...
- **Automatic API Documentation**: Interactive Scalar documentation is automatically generated and served at `/api`. The raw OpenAPI JSON spec is available at `/api/openapi.json`.
